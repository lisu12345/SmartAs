...
install("web.demo.plugins.antd",function($S){
	...
	const {Select, Radio,Checkbox,Input, Button, DatePicker, InputNumber, Form,FormItem, Cascader,Card} = UI
	let message;
