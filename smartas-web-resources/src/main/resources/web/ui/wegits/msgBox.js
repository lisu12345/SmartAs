...
ZENG.dom = {
	...
	createElementIn: function createElementIn(tagName, elem, insertFirst, attrs) {
	...
	setStyle: function setStyle(el, properties, value) {
	...
	getScrollTop: function getScrollTop(doc) {
		var _doc = doc || document;
		return Math.max(_doc.documentElement.scrollTop, _doc.body.scrollTop);
	},
	getClientHeight: function getClientHeight(doc) {
		var _doc = doc || document;
...
ZENG.string = {
	...
	commonReplace: function commonReplace(s, p, r) {
...
ZENG.msgbox.show = function (msgHtml, type, timeout, opts) {
	...
	opts = opts || {};
	var _s = ZENG.msgbox,
	    template = '<span class="zeng_msgbox_layer" style="display:none;z-index:10000;" id="mode_tips_v2"><i class="fa fa-cog fa-spin"></i>{msgHtml}<span class="gtl_end"></span></span>',
