package org.smartas.devops.generator.config;

import static org.smartas.devops.generator.util.EqualsUtil.areEqual;
import static org.smartas.devops.generator.util.HashCodeUtil.SEED;
import static org.smartas.devops.generator.util.HashCodeUtil.hash;
...
import org.smartas.devops.generator.api.ModelType;
import org.smartas.devops.generator.api.dom.xml.Attribute;
import org.smartas.devops.generator.api.dom.xml.XmlElement;
...
public class TableConfig extends PropertyHolder {
   ...
   * 
   *         public ColumnOverride getColumnOverride(String columnName) { for (ColumnOverride co :
   *         columnOverrides) { if (co.isColumnNameDelimited()) { if
   *         (columnName.equals(co.getColumnName())) { return co; } } else { if
   *         (columnName.equalsIgnoreCase(co.getColumnName())) { return co; } } }
   * 
   *         return null; }
   */
  /**
  ...
  public boolean areAnyStatementsEnabled() {
    return selectByExampleStatementEnabled || selectByPrimaryKeyStatementEnabled
        || insertStatementEnabled || updateByPrimaryKeyStatementEnabled
        || deleteByExampleStatementEnabled || deleteByPrimaryKeyStatementEnabled
   ...
   * 
   *         public List<ColumnOverride> getColumnOverrides() { return columnOverrides; }
   */
  /**
   * This method returns a List of Strings. The values are the columns that were specified to be
  ...
  public void validate(List<String> errors, int listPosition) {
    ...
    /*
     * if (columnRenamingRule != null) { columnRenamingRule.validate(errors, fqTableName); }
     * 
     * for (ColumnOverride columnOverride : columnOverrides) { columnOverride.validate(errors,
     * fqTableName); }
     * 
     * for (IgnoredColumn ignoredColumn : ignoredColumns.keySet()) { ignoredColumn.validate(errors,
     * fqTableName); }
     */
  }
