package org.smartas.devops.generator.meta;
...
import org.smartas.devops.generator.config.GeneratedKey;
...
public class IntrospectedTable {
  ...
  protected TableConfig tableConfiguration;
  ...
  public IntrospectedTable() {
    super();
    this.targetRuntime = TargetRuntime.MYBATIS3;
   ...
   * 
   *         public String getSelectByExampleQueryId() { return
   *         tableConfiguration.getSelectByExampleQueryId(); }
   */
  /**
   ...
   * 
   *         public String getSelectByPrimaryKeyQueryId() { return
   *         tableConfiguration.getSelectByPrimaryKeyQueryId(); }
   */
  /**
  ...
  public void setTableConfiguration(TableConfig tableConfiguration) {
  ...
  public void initialize() {
    ...
    /*
     * if (tableConfiguration.getModelType() == ModelType.HIERARCHICAL) { rules = new
     * HierarchicalModelRules(this); } else if (tableConfiguration.getModelType() == ModelType.FLAT)
     * { rules = new FlatModelRules(this); } else { rules = new ConditionalModelRules(this); }
     * 
   ...
   *         JavaClientGeneratorConfiguration config =
   *         context.getJavaClientGeneratorConfiguration(); if (config == null) { return null; }
   * 
   *         StringBuilder sb = new StringBuilder(); if
   *         (stringHasValue(config.getImplementationPackage())) {
   *         sb.append(config.getImplementationPackage()); } else {
   ...
   * 
   *         private boolean isSubPackagesEnabled(PropertyHolder propertyHolder) { return
   *         isTrue(propertyHolder.getProperty(PropertyRegistry.ANY_ENABLE_SUB_PACKAGES)); }
   */
  /**
   ...
   *         context.getJavaClientGeneratorConfiguration(); if (config == null) { return null; }
   * 
   *         StringBuilder sb = new StringBuilder(); sb.append(config.getTargetPackage());
   * 
   *         sb.append(fullyQualifiedTable.getSubPackage(isSubPackagesEnabled(config)));
   * 
   *         return sb.toString(); }
   ...
   * 
   * protected void calculateJavaClientAttributes() { if
   * (context.getJavaClientGeneratorConfiguration() == null) { return; }
   * 
   * StringBuilder sb = new StringBuilder(); sb.append(calculateJavaClientImplementationPackage());
   * sb.append('.'); sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("DAOImpl");
   * //$NON-NLS-1$ setDAOImplementationType(sb.toString());
   * 
   * sb.setLength(0); sb.append(calculateJavaClientInterfacePackage()); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("DAO"); //$NON-NLS-1$
   * setDAOInterfaceType(sb.toString());
   * 
   * sb.setLength(0); sb.append(calculateJavaClientInterfacePackage()); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("Mapper"); //$NON-NLS-1$
   * setMyBatis3JavaMapperType(sb.toString());
   * 
   * sb.setLength(0); sb.append(calculateJavaClientInterfacePackage()); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("SqlProvider"); //$NON-NLS-1$
   ...
   * @return the string
   * 
   *         protected String calculateJavaModelPackage() { JavaModelGeneratorConfiguration config =
   ...
   * 
   * protected void calculateModelAttributes() { String pakkage = calculateJavaModelPackage();
   * 
   * StringBuilder sb = new StringBuilder(); sb.append(pakkage); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("Key"); //$NON-NLS-1$
   * setPrimaryKeyType(sb.toString());
   * 
   * sb.setLength(0); sb.append(pakkage); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); setBaseRecordType(sb.toString());
   * 
   * sb.setLength(0); sb.append(pakkage); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("WithBLOBs"); //$NON-NLS-1$
   * setRecordWithBLOBsType(sb.toString());
   * 
   * sb.setLength(0); sb.append(pakkage); sb.append('.');
   * sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("Example"); //$NON-NLS-1$
   ...
   * @return the string
   * 
   *         protected String calculateSqlMapPackage() { StringBuilder sb = new StringBuilder();
   *         SqlMapGeneratorConfiguration config = context.getSqlMapGeneratorConfiguration();
   * 
   *         // config can be null if the Java client does not require XML if (config != null) {
   *         sb.append(config.getTargetPackage());
   *         sb.append(fullyQualifiedTable.getSubPackage(isSubPackagesEnabled(config))); }
   * 
   *         return sb.toString(); }
   ...
   * @return the string
   * 
   *         protected String calculateMyBatis3FallbackSqlMapNamespace() { StringBuilder sb = new
   *         StringBuilder(); sb.append(calculateSqlMapPackage()); sb.append('.');
   *         sb.append(fullyQualifiedTable.getDomainObjectName()); sb.append("Mapper");
   ...
   * 
   *         public boolean isImmutable() { Properties properties;
   * 
   *         if (tableConfiguration.getProperties().containsKey(PropertyRegistry.ANY_IMMUTABLE)) {
   *         properties = tableConfiguration.getProperties(); } else { properties =
   *         context.getJavaModelGeneratorConfiguration().getProperties(); }
   * 
   ...
   * 
   *         if
   *         (tableConfiguration.getProperties().containsKey(PropertyRegistry.ANY_CONSTRUCTOR_BASED)
   *         ) { properties = tableConfiguration.getProperties(); } else { properties =
   *         context.getJavaModelGeneratorConfiguration().getProperties(); }
   * 
