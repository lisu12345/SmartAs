 ...
 * the License.
 */
package com.fiberhome.smartas.core.sql.scripting;
...
import com.fiberhome.smartas.core.sql.mapping.PageSqlSource;
import com.fiberhome.smartas.core.sql.scripting.xmltags.QuerySqlNode;
...
public class XMLScriptBuilder extends BaseBuilder {
  ...
  private class QueryHandler implements NodeHandler {
    public void handleNode(XNode nodeToHandle, List<SqlNode> targetContents) {
      String open = nodeToHandle.getStringAttribute("open");
      String close = nodeToHandle.getStringAttribute("close");
      final String expression = nodeToHandle.getStringAttribute("value","query");
      final String filterName = nodeToHandle.getStringAttribute("filterName","T");
      final QuerySqlNode node = new QuerySqlNode(open, close, expression, filterName);
      targetContents.add(node);
    }
  }
