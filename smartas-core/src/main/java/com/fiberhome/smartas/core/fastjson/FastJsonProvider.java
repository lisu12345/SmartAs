...
import com.fiberhome.smartas.core.annotation.FastJsonType;
import com.fiberhome.smartas.core.util.IOUtils;
...
public class FastJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
  ...
  protected FastJsonConfig fastJsonConfig =
      new FastJsonConfig(new SerializeConfig(), null, null, new ParserConfig(), null);
  ...
  /**
   * Only serialize/deserialize all types annotated with {@link com.fiberhome.smartas.core.annotation.colobu.fastjson.FastJsonType}.
   */
  ...
  /**
   * Check whether a class can be serialized or deserialized. It can check based on packages,
   * annotations on entities or explicit classes.
   * 
   ...
   * be serialized by this provider.
   */
   ...
   * always return -1 to denote "not known".
   */
  ...
  public void writeTo(Object t, Class<?> type, Type genericType, Annotation[] annotations,
    ...
    if (uriInfo != null && uriInfo.getQueryParameters().containsKey("pretty")) {
      if (fastJsonConfig.serializerFeatures == null)
        ...
        List<SerializerFeature> serializerFeatures =
            Arrays.asList(fastJsonConfig.serializerFeatures);
    ...
    if (fastJsonConfig.serializeFilters != null) filter = fastJsonConfig.serializeFilters.get(type);
    String jsonStr = toJSONString(t, filter, fastJsonConfig.serializerFeatures);
    if (jsonStr != null) entityStream.write(jsonStr.getBytes());
  }
   ...
   * type) can be deserialized by this provider.
   */
  ...
  public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations,
    ...
    if (fastJsonConfig.features == null)
      return JSON.parseObject(input, type, fastJsonConfig.parserConfig,
